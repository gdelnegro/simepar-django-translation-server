...
def load_data(apps, schema_editor):
    __load_data(apps=apps, type="MDL", tag="MDL12", text="Migration created", text_en="Migration created", text_de="TestDesss", text_pt_br="\"Migration\" criada", auxiliary_tag="TTP12", auxiliary_text="If this record migration was created", auxiliary_text_en="If this record migration was created", auxiliary_text_de="Test", auxiliary_text_pt_br="Se a migration desse registro foi criada", migration_created="True")
